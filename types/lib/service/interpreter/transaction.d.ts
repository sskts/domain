...
export default class TransactionServiceInterpreter implements TransactionService {
     ...
     * @memberOf TransactionServiceInterpreter
     */
    start(expiredAt: Date): (ownerRepository: OwnerRepository, transactionRepository: TransactionRepository) => Promise<Transaction>;
    /**
     * GMO資産承認
     *
     * @param {string} transactionId
     ...
     * @memberOf TransactionServiceInterpreter
     */
    addGMOAuthorization(transactionId: string, authorization: GMOAuthorization): (transactionRepository: TransactionRepository) => Promise<void>;
    /**
     * COA資産承認
     *
     * @param {string} transactionId
     ...
     * @memberOf TransactionServiceInterpreter
     */
    addCOASeatReservationAuthorization(transactionId: string, authorization: COASeatReservationAuthorization): (transactionRepository: TransactionRepository) => Promise<void>;
    /**
     * 資産承認解除
     *
     * @param {string} transactionId
     ...
     * @memberOf TransactionServiceInterpreter
     */
    removeAuthorization(transactionId: string, authorizationId: string): (transactionRepository: TransactionRepository) => Promise<void>;
    /**
     * 照合を可能にする
     *
     * @param {string} transactionId
     ...
     * @memberOf TransactionServiceInterpreter
     */
    enableInquiry(transactionId: string, key: TransactionInquiryKey): (transactionRepository: TransactionRepository) => Promise<void>;
    /**
     * 照会する
     *
     * @param {TransactionInquiryKey} key
     ...
     * @memberOf TransactionServiceInterpreter
     */
    close(transactionId: string): (transactionRepository: TransactionRepository) => Promise<void>;
    /**
     * 取引期限切れ
     *
     * @returns {TransactionOperation<void>}
     ...
     * @memberOf TransactionServiceInterpreter
     */
    expireOne(): (transactionRepository: TransactionRepository) => Promise<void>;
    /**
     * キュー出力
     *
     * @param {string} transactionId
     ...
     * @memberOf TransactionServiceInterpreter
     */
    exportQueues(transactionId: string): (transactionRepository: TransactionRepository, queueRepository: QueueRepository) => Promise<void>;
    /**
     * メール追加
     *
     * @param {string} transactionId
     ...
     * @memberOf TransactionServiceInterpreter
     */
    addEmail(transactionId: string, notification: EmailNotification): (transactionRepository: TransactionRepository) => Promise<void>;
    /**
     * メール削除
     *
     * @param {string} transactionId
     ...
     * @memberOf TransactionServiceInterpreter
     */
    removeEmail(transactionId: string, notificationId: string): (transactionRepository: TransactionRepository) => Promise<void>;
