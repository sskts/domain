...
(function (Authorization) {
    ...
    function createGMO(args) {
        return new GMOAuthorization((args._id) ? args._id : objectId_1.default(), args.price, args.owner_from, args.owner_to, args.gmo_shop_id, args.gmo_shop_pass, args.gmo_order_id, args.gmo_amount, args.gmo_access_id, args.gmo_access_pass, args.gmo_job_cd, args.gmo_pay_type);
    }
    Authorization.createGMO = createGMO;
    function createCOASeatReservation(args) {
        return new COASeatReservationAuthorization((args._id) ? args._id : objectId_1.default(), args.coa_tmp_reserve_num, args.coa_theater_code, args.coa_date_jouei, args.coa_title_code, args.coa_title_branch_num, args.coa_time_begin, args.coa_screen_code, args.price, args.owner_from, args.owner_to, args.assets);
    }
