...
(function (Queue) {
    ...
    class DisableTransactionInquiryQueue extends Queue {
         ...
         */
        constructor(id, status, run_at, max_count_try, last_tried_at, count_tried, results, transaction_id) {
    ...
    function createDisableTransactionInquiry(args) {
        return new DisableTransactionInquiryQueue(args.id, args.status, args.run_at, args.max_count_try, args.last_tried_at, args.count_tried, args.results, args.transaction_id);
    }
