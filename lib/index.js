...
const TradeInProgressService = require("./service/tradeInProgress");
const action_1 = require("./adapter/action");
...
const ActionScopeFactory = require("./factory/actionScope");
...
(function (adapter) {
    function action(connection) {
        return new action_1.default(connection);
    }
...
(function (service) {
    ...
    service.tradeInProgress = TradeInProgressService;
...
(function (factory) {
    ...
    (function (actionEvent) {
        actionEvent.addNotification = AddNotificationActionEventFactory;
        actionEvent.authorize = AuthorizeActionEventFactory;
        actionEvent.removeNotification = RemoveNotificationActionEventFactory;
        actionEvent.unauthorize = UnauthorizeActionEventFactory;
    })(actionEvent = factory.actionEvent || (factory.actionEvent = {}));
    factory.actionEventGroup = actionEventType_1.default;
    factory.actionScope = ActionScopeFactory;
    factory.actionStatusType = actionStatusType_1.default;
    factory.actionTasksExportationStatus = actionTasksExportationStatus_1.default;
