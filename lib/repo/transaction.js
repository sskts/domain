...
class TransactionRepository {
    ...
    startPlaceOrder(transaction) {
        return __awaiter(this, void 0, void 0, function* () {
            // mongoDBに追加するために_id属性を拡張
            yield this.transactionModel.create(Object.assign({}, transaction, { _id: transaction.id }));
        });
    }
    /**
     ...
     */
    setCustomerContactsOnPlaceOrderInProgress(transactionId, profile) {
        return __awaiter(this, void 0, void 0, function* () {
