    ...
    find(conditions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const docs = yield model.find(conditions)
                ...
                .populate('screen')
                .exec();
            return docs.map((doc) => performance_1.default.create(doc.toObject()));
        });
    }
    findById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const doc = yield model.findOne({ _id: id })
                ...
                .populate('screen')
                .exec();
            return (doc) ? monapt.Option(performance_1.default.create(doc.toObject())) : monapt.None;
        });
    }
    store(performance) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield model.findOneAndUpdate({ _id: performance.id }, performance.toDocument(), {
                new: true,
                upsert: true
            }).lean().exec();
        });
