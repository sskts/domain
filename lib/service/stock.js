    ...
    return (assetAdapter, ownerAdapter, performanceAdapter) => __awaiter(this, void 0, void 0, function* () {
        ...
        yield Promise.all(authorization.assets.map((asset) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (stateReserveResult !== null) {
                ...
                qr = stateReserveResult.list_ticket.find((stateReserveTicket) => (stateReserveTicket.seat_num === asset.seat_code)).seat_qrcode;
            }
            else {
                // tslint:disable-next-line:max-line-length
                qr = updReserveResult.list_qr.find((updReserveQR) => (updReserveQR.seat_num === asset.seat_code)).seat_qrcode;
            }
...
function updatePerformanceAvailability(theaterCode, dayStart, dayEnd) {
    return (performanceStockStatusAdapter) => __awaiter(this, void 0, void 0, function* () {
        ...
        yield Promise.all(countFreeSeatResult.list_date.map((countFreeSeatDate) => __awaiter(this, void 0, void 0, function* () {
            ...
            yield Promise.all(countFreeSeatDate.list_performance.map((countFreeSeatPerformance) => __awaiter(this, void 0, void 0, function* () {
                ...
                const availability = PerformanceStockStatusFactory.create(countFreeSeatDate.date_jouei, countFreeSeatPerformance.cnt_reserve_free, countFreeSeatPerformance.cnt_reserve_max);
                // 永続化
                debug('saving performance availability... id:', performanceId);
                yield performanceStockStatusAdapter.saveByPerformance(countFreeSeatDate.date_jouei, performanceId, availability);
                debug('performance availability saved');
            })));
        })));
    });
}
exports.updatePerformanceAvailability = updatePerformanceAvailability;
