...
function importScreens(theaterCode) {
    return (theaterAdapter, screenRepo) => __awaiter(this, void 0, void 0, function* () {
        ...
        const theater = doc.toObject();
        // COAからスクリーン取得
        const screens = yield COA.services.master.screen({
            theater_code: theaterCode
        });
        // 永続化
 ...
 * @memberof service/master
 */
function searchTheaters(searchConditions) {
    return (theaterAdapter) => __awaiter(this, void 0, void 0, function* () {
        ...
        const docs = yield theaterAdapter.model.find(conditions, 'id name name_kana address websites')
            .setOptions({ maxTimeMS: 10000 })
            .exec();
        const theaters = [];
...
function searchPerformances(searchConditions) {
    return (performanceRepo, performanceStockStatusAdapter) => __awaiter(this, void 0, void 0, function* () {
        // 検索条件を作成
        const conditions = {};
        ...
        yield Promise.all(docs.map((doc) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (performanceStockStatusAdapter !== undefined) {
                stockStatus = yield performanceStockStatusAdapter.findOne(doc.get('day'), doc.get('id'));
