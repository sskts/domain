...
function importFilms(theaterCode) {
    return (theaterAdapter, filmRepo) => __awaiter(this, void 0, void 0, function* () {
        // 劇場取得
        const optionTheater = yield theaterAdapter.findById(theaterCode);
        ...
        yield Promise.all(films.map((filmFromCOA) => __awaiter(this, void 0, void 0, function* () {
            const film = yield Film.createFromCOA(filmFromCOA)(optionTheater.get());
...
function findTheater(theaterId) {
    ...
    return (adapter) => __awaiter(this, void 0, void 0, function* () { return yield adapter.findById(theaterId); });
}
...
function findFilm(filmId) {
    ...
    return (adapter) => __awaiter(this, void 0, void 0, function* () { return yield adapter.findById(filmId); });
}
...
function findScreen(screenId) {
    ...
    return (adapter) => __awaiter(this, void 0, void 0, function* () { return yield adapter.findById(screenId); });
}
...
function findPerformance(performanceId) {
    ...
    return (adapter) => __awaiter(this, void 0, void 0, function* () { return yield adapter.findById(performanceId); });
}
