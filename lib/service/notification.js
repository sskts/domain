...
function sendEmail(email) {
    return () => __awaiter(this, void 0, void 0, function* () {
        ...
        const mail = new sendgrid.mail.Mail(new sendgrid.mail.Email(email.data.from), email.data.subject, new sendgrid.mail.Email(email.data.to), new sendgrid.mail.Content('text/plain', email.data.content));
