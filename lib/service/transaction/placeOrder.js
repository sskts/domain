...
function start(args) {
    return (
        ...
        // 売り手を取得
        const sellerDoc = yield organizationRepository.organizationModel.findById(args.sellerId).exec();
        if (sellerDoc === null) {
        ...
        yield transactionRepository.transactionModel.create(Object.assign({}, transaction, { _id: transaction.id }));
        return transaction;
    });
}
exports.start = start;
...
function makeExpired() {
    return (transactionRepository) => __awaiter(this, void 0, void 0, function* () {
        ...
        // ステータスと期限を見て更新
        yield transactionRepository.transactionModel.update({
            status: factory.transactionStatusType.InProgress,
            expires: { $lt: endDate }
        }, {
...
function exportTasksById(transactionId) {
    ...
    return (taskRepository, transactionRepository) => __awaiter(this, void 0, void 0, function* () {
        const transaction = yield transactionRepository.transactionModel.findById(transactionId).exec()
            .then((doc) => {
            if (doc === null) {
        ...
        yield Promise.all(tasks.map((task) => __awaiter(this, void 0, void 0, function* () {
            ...
            yield taskRepository.taskModel.findByIdAndUpdate(task.id, task, { upsert: true }).exec();
        })));
        return tasks;
    });
}
...
function findInProgressById(transactionId) {
    return (transactionRepository) => __awaiter(this, void 0, void 0, function* () {
        const doc = yield transactionRepository.transactionModel.findOne({
            _id: transactionId,
...
function createCreditCardAuthorization(transactionId, orderId, amount, method, creditCard) {
    return (organizationRepository, transactionRepository) => __awaiter(this, void 0, void 0, function* () {
        const transaction = yield findInProgressById(transactionId)(transactionRepository);
        // GMOショップ情報取得
        const movieTheater = yield organizationRepository.organizationModel.findById(transaction.seller.id).exec()
            .then((doc) => {
            if (doc === null) {
...
function setAgentProfile(transactionId, profile) {
    return (transactionRepository) => __awaiter(this, void 0, void 0, function* () {
        yield findInProgressById(transactionId)(transactionRepository);
        // 永続化
