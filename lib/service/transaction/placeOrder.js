...
function createMvtkAuthorization(transactionId, authorization) {
    return (transactionAdapter) => __awaiter(this, void 0, void 0, function* () {
        ...
        if (authorization.result.stCd !== stCdShouldBe) {
            throw new argument_1.default('authorization', 'stCd not matched with seat reservation authorization');
        }
        // skhnCd matched?
        ...
        if (authorization.result.skhnCd !== skhnCdShouldBe) {
            throw new argument_1.default('authorization', 'skhnCd not matched with seat reservation authorization');
        }
        // screen code matched?
        if (authorization.result.screnCd !== seatReservationAuthorization.object.updTmpReserveSeatArgs.screenCode) {
            throw new argument_1.default('authorization', 'screnCd not matched with seat reservation authorization');
        }
        // seat num matched?
        ...
        if (!authorization.result.zskInfo.every((zskInfo) => seatNumsInSeatReservationAuthorization.indexOf(zskInfo.zskCd) >= 0)) {
            throw new argument_1.default('authorization', 'zskInfo not matched with seat reservation authorization');
        }
