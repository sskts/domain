...
function createCreditCardAuthorization(transactionId, orderId, amount, method, creditCard) {
    return (organizationAdapter, transactionAdapter) => __awaiter(this, void 0, void 0, function* () {
        ...
        const movieTheater = yield organizationAdapter.organizationModel.findById(transaction.seller.id).exec()
            .then((doc) => {
            if (doc === null) {
                throw new argument_1.default('transactionId', 'movieTheater not found');
            }
            return doc.toObject();
        });
        // GMOオーソリ取得
        ...
        try {
            ...
            if (error.name === 'GMOServiceBadRequestError') {
                ...
                if (serviceUnavailableError !== undefined) {
                    throw new serviceUnavailable_1.default('payment service unavailable temporarily');
                }
                else {
                    throw new argument_1.default('payment');
                }
            }
