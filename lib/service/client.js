...
function pushEvent(params) {
    return (clientRepository) => __awaiter(this, void 0, void 0, function* () {
        ...
        yield clientRepository.clientEventModel.findByIdAndUpdate(clientEvent.id, clientEvent, { upsert: true }).exec();
        return clientEvent;
    });
}
