 ...
 * @memberof service/transaction
 */
function startIfPossible(expiresAt, unitOfCountInSeconds, maxCountPerUnit) {
    return (ownerAdapter, transactionAdapter, transactionCountAdapter) => __awaiter(this, void 0, void 0, function* () {
        // 利用可能かどうか
        const scope = 'all';
        const available = yield isAvailable(scope, unitOfCountInSeconds, maxCountPerUnit)(transactionCountAdapter);
        if (!available) {
            return monapt.None;
        }
        ...
        const transactionDoc = yield transactionAdapter.transactionModel.create(newTransactionDoc);
