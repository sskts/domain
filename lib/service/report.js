 ...
 */
function createTelemetry(scope, unitOfCountInSeconds, maxCountPerUnit) {
    return (queueAdapter, telemetryAdapter, transactionAdapter, transactionCountAdapter) => __awaiter(this, void 0, void 0, function* () {
        ...
        return new Promise((resolve, reject) => {
            transactionCountAdapter.redisClient.get(redisKey, (err, replies) => __awaiter(this, void 0, void 0, function* () {
                ...
                const telemetry = yield telemetryAdapter.telemetryModel.create({
                    transactions: {
