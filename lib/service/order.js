...
function createFromOldTransaction(transactionId) {
    return (__, transactionAdapter, filmAdapter, performanceAdapter, screenAdapter, theaterAdapter) => __awaiter(this, void 0, void 0, function* () {
...
function getOldTransactionDetails(transactionId) {
    return (transactionAdapter, filmAdapter, performanceAdapter, screenAdapter, theaterAdapter) => __awaiter(this, void 0, void 0, function* () {
        ...
        const authorizations = yield findAuthorizationsById(transaction.id)(transactionAdapter);
        // GMOオーソリを取り出す
...
function findAuthorizationsById(transactionId) {
    return (transactionAdapter) => __awaiter(this, void 0, void 0, function* () {
        const authorizations = (yield transactionAdapter.transactionEventModel.find({
        ...
        const removedAuthorizationIds = (yield transactionAdapter.transactionEventModel.find({
            transaction: transactionId,
            group: 'UNAUTHORIZE'
        }, 'authorization.id')
            .setOptions({ maxTimeMS: 10000 })
...
exports.findAuthorizationsById = findAuthorizationsById;
