...
function createFromTransaction(transactionId) {
    return (orderRepository, transactionRepository) => __awaiter(this, void 0, void 0, function* () {
...
function findByOrderInquiryKey(orderInquiryKey) {
    return (orderRepository) => __awaiter(this, void 0, void 0, function* () {
        const doc = yield orderRepository.orderModel.findOne({
