...
function executeSendEmailNotification() {
    return (queueAdapter) => __awaiter(this, void 0, void 0, function* () {
        ...
        return (queueDoc) ? queueDoc.get('status') : null;
    });
}
...
function abort(intervalInMinutes) {
    return (queueAdapter) => __awaiter(this, void 0, void 0, function* () {
        ...
        if (abortedQueueDoc) {
            // メール通知
            yield notificationService.sendEmail(notification.createEmail({
...
`
        ...
        return (abortedQueueDoc) ? abortedQueueDoc.get('id') : null;
    });
}
exports.abort = abort;
