...
function searchMovieTheaters(searchConditions) {
    return (organizationAdapter) => __awaiter(this, void 0, void 0, function* () {
        ...
        return yield organizationAdapter.organizationModel.find(conditions, 'identifier name legalName typeOf location url branchCode parentOrganization gmoInfo.shopId')
...
function findMovieTheaterByBranchCode(branchCode) {
    return (organizationAdapter) => __awaiter(this, void 0, void 0, function* () {
        const doc = yield organizationAdapter.organizationModel.findOne({
            typeOf: factory.organizationType.MovieTheater,
