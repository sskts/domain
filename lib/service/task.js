...
function executeByName(taskName) {
    return (taskAdapter) => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (typeof TaskFunctionsService[taskName] !== 'function') {
                throw new TypeError(`function undefined ${taskName}`);
            }
            yield TaskFunctionsService[taskName](task.data);
...
function abort(intervalInMinutes) {
    return (taskAdapter) => __awaiter(this, void 0, void 0, function* () {
        ...
        yield NotificationService.report2developers('キューの実行が中止されました', `id:${abortedTaskDoc.get('_id')}
