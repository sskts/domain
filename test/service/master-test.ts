...
describe("master service", () => {
  it("importTheater fail", (done) => {
    SSKTS.createMasterService().importTheater("000")(SSKTS.createTheaterRepository(mongoose.connection))
      .then(() => {
  ...
  it("importTheater ok", (done) => {
    SSKTS.createMasterService().importTheater("118")(SSKTS.createTheaterRepository(mongoose.connection))
      .then(() => {
        done();
      })
      .catch((err) => {
